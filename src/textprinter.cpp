...
bool TextPrinter::preparePrint(const QString &caption,
			   bool selection) {
	...
	//
	if (selection) {
		dialog.setOptions(dialog.options() | QAbstractPrintDialog::PrintSelection);
	}
...
bool TextPrinter::isPrintSelection() {
	return (printer_->printRange() == QPrinter::Selection);
}
